...
| `src-dpmc-powers-authorisations-level3-2020` | `D-family D/E bridge` | `2020-04-22` Level 3 powers and authorisations | `verified` | `verified` | `accepted and coded` | promoted into the late-transition ledger to make the Level 3 authority-routing chain explicit |
...
| `src-taiwan-all-travelers-home-quarantine-2020` | `E-family` | `2020-02-08` entry home-quarantine tightening for specified transit and endemic-area travelers | `verified` | `verified` | `accepted and coded` | direct early entry-home-quarantine tightening anchor with border and public-guidance relevance |
