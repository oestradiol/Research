# Taiwan Official Corpus Inventory
...
Every promoted source in this file has:

- a verified live official URL
- a verified fixed archive URL

Unstable candidates remain in [Source Discovery Log](source-discovery-log.md).

## Current accepted official source set
...
- [src-taiwan-home-quarantine-health-agency-routing-2020](../../../../references/source-registry.md#src-taiwan-home-quarantine-health-agency-routing-2020)
...
| implementation-observed health-agency routing during quarantine | visible |
| local administrative support routing | visible |
