...
This page is the site map for the Structured Unity Framework public package: every major Markdown surface, grouped by role, with a one-line explanation.
...
| `docs/monograph-and-closure-program.md` | Canonical long-range phase ladder toward monograph-grade completion |
...
Use `applications/README.md` to route between demonstrated routes and research-map nodes.

## `references/`

Use `references/source-registry.md` for the canonical public source registry.

## `meta/`

Use `meta/publication-scope.md` for publication-scope and non-claim discipline.
