...
## 6. Publication-finalization phase

- final editorial polish before actual publication
- remote hosting and hosted package URLs
- changelog grounding to remote git history
- first tagged release, release notes, and publication packaging
