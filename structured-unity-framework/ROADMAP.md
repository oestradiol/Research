...
## 1. Hosted `v1.1.0` and current `main`

The hosted `v1.1.0` tag is the dated bounded release.

Current `main` is aligned with the hosted `v1.1.0` New Zealand monograph-baseline release for the same public package line. That means later `1.x` work is a deliberate reopening toward comparator completion, bounded closure, and tooling maturity rather than a continuation of unfinished launch mechanics.
...
1. `v1.2` Taiwan completion
2. `v1.3` Australia federal comparator
3. `v1.4` bounded pandemic-governance closure and monograph-grade repo
