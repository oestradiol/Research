...
The hosted `v1.5.0` tag is the dated bounded release.

Current `main` is aligned with the hosted `v1.5.0` release for the same public package line. That means later `1.x` work is a deliberate reopening toward comparator completion, bounded closure, and tooling maturity rather than a continuation of unfinished launch mechanics.
...
1. ✅ `v1.2` Taiwan completion (20 events, threshold met)
2. ✅ `v1.3` Australia federal comparator (18 events, AHPPC + National Cabinet dual-layer, federal-only scope)
3. ✅ `v1.4` bounded pandemic-governance closure and monograph structure (76 events, 3-case synthesis, rival-framework positioning)
